...
[← ০৫। wget-এর ব্যবহার](../০৫-wget-এর-ব্যবহার)

---

## ⏭️ Next Chapter

[০৭। Shell Scripting Fundamentals →](../০৭-শেল-স্ক্রিপ্টিং-ফান্ডামেন্টালস)

---

## 📚 Linux Book

লিনাক্স শেখার ধারাবাহিক বাংলা বইয়ের অংশ।

সিরিজটি অনুসরণ করলে আপনি:
...
ধাপে ধাপে শিখতে পারবেন।
````

এটি আগের ভার্সনের তুলনায় অনেক বেশি আর্কিটেকচার-কেন্দ্রিক, DevOps-friendly এবং GitHub Book-এর জন্য উপযুক্ত।
